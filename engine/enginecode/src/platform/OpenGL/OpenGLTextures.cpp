/** \file OpenGLTextures.cpp
*Implementation of the textures abstraction in OpenGL
*/
...
namespace Engine
{
	OpenGLTextures::OpenGLTextures(const char* filepath)
	{
	...
	OpenGLTextures::OpenGLTextures(uint32_t width, uint32_t height, uint32_t channels, unsigned char* data)
	{
		if (data) init(width, height, channels, data);
	...
	void OpenGLTextures::edit(uint32_t xOffset, uint32_t yOffset, uint32_t width, uint32_t height, unsigned char* data)
	{
	...
	void OpenGLTextures::init(uint32_t width, uint32_t height, uint32_t channels, unsigned char* data)
	{
